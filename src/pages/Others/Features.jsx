    ...
    return (
        <MyContainer>
          ...
          <h2 className="text-4xl font-bold text-center text-emerald-800 mb-12 dark:bg-gray-800 
            dark:text-gray-100">Powerful Features</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        {[
          ...
          <div key={i} className="text-center dark:bg-gray-800 
            dark:text-gray-100 p-8 rounded-2xl hover:scale-105 transition-transform duration-300 shadow-md">
            <f.icon className="text-6xl text-emerald-700 mx-auto mb-4" />
            <h3 className="text-2xl font-bold text-emerald-800 mb-3 dark:bg-gray-800 
            dark:text-gray-100">{f.title}</h3>
            <p className="text-gray-700 dark:bg-gray-800 
            dark:text-gray-100">{f.desc}</p>
          </div>
        ))}
                </div>
                </section>
