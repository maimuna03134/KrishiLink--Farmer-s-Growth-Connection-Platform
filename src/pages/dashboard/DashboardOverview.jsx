...
const API_BASE_URL = 'https://krisilink-farmer-growth-connection.vercel.app';
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-8">
            <div className="max-w-7xl mx-auto">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">Crops Dashboard</h1>
                    <p className="text-gray-600 dark:text-gray-400">Overview of your agricultural marketplace</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-emerald-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Total Crops</p>
                                <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">{stats.totalCrops}</p>
                            </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">${stats.totalValue.toLocaleString()}</p>
                            </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-amber-500">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">{stats.categories}</p>
                            </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">{stats.locations}</p>
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Quantity by Location</h2>
                        <ResponsiveContainer width="100%" height={300}>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 lg:col-span-2">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Price per Unit (Top 10 Crops)</h2>
                        <ResponsiveContainer width="100%" height={300}>
                ...
                <div className=" rounded-xl shadow-lg p-6">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Recent Crops</h2>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b-2 border-gray-200 dark:border-gray-700">
                                    ...
                                    <th className="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Price/Unit</th>
                                    <th className="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Total Value</th>
                                    <th className="text-center py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                {getRecentCrops().map((crop, index) => (
                                    <tr key={crop._id} className={`border-b border-gray-100 dark:border-gray-700 hover:bg-green-200 dark:hover:bg-gray-700 transition ${index % 2 === 0 ? '' : ''}`}>
                                        <td className="py-3 px-4 font-medium text-gray-600 dark:text-gray-400 ">{crop.name}</td>
                                        <td className="py-3 px-4">
                                            <span className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-emerald-100 text-emerald-700">
                                                {crop.type}
                                            </span>
                                        </td>
                                        <td className="py-3 px-4 font-medium  text-gray-600 dark:text-gray-400">{crop.location}</td>
                                        <td className="py-3 px-4 text-right text-gray-900 dark:text-gray-100">{crop.quantity} {crop.unit}</td>
                                        <td className="py-3 px-4 text-right font-medium text-gray-900 dark:text-gray-100">${crop.pricePerUnit}</td>
